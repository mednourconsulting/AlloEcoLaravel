...
<html lang="fr">
  ...
  <div class="site-wrap"  id="home-section">
    ...
    <div class="site-section-cover overlay inner-page bg-light" style="background-image: url({{ asset('storage/'.$activite->file) }})" data-aos="fade">
          ...
          <div class="col-lg-10">
            ...
            <div class="box-shadow-content">
              <div class="block-heading-1">
                <span class="d-block mb-3 text-white" data-aos="fade-up">{{ $activite->created_at }}<span class="mx-2 text-primary">&bullet;</span>OPEMH</span>
                <h1 class="mb-4" data-aos="fade-up" data-aos-delay="100">{{ $activite->titre }}</h1>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4 sidebar">
            <div class="sidebar-box">
              <h2>d'autre activités</h2>
              <ul class="list-unstyled">
                @foreach($activites as $act)
                <li class="mb-4">
                  <h2 class="h4"><form class="" action="{{ url('activite/'.$act->id) }}" method="post">
                    <a href="{{ url('activite/'.$act->id) }}" class="h4">{{ $act->titre }}</a>
                  </form></h2>
                  <span class="d-block text-secondary">{{ $act->created_at }}</span>
                  <p>{{ substr(strip_tags($act->body),0,250) }}{{ strlen(strip_tags($act->body)) > 250 ? '...' : "" }}</p>
                </li>
                @endforeach
              </ul>
