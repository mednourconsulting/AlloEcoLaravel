...
<div class="page-wrapper">
  <div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">Modifier l'activité</h3>
            <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-12">
      <form form method="POST" action="{{ url('/admin/activites/'.$activite->id) }}" enctype="multipart/form-data" files="true">
        ...
        <div class="form-group row">
          ...
          <div class="form-group row">
              ...
              <textarea name="body" class="form-control" id="tinymce">{{ $activite->body }}</textarea>
              @if($errors->get('body'))
